document.addEventListener('DOMContentLoaded', () => {
    // Lädt globale Teilnehmer (Tische und Laufkundschaft)
      ...
      return Promise.all([
        ...
        const tableParticipants = tables.map(t => {
          return {
            ...
            id: t.id,
            name: t.name,
            // Falls ein optionaler Name vorhanden ist, wird dieser als Haupttext verwendet, der originale Name in kleiner Schrift
